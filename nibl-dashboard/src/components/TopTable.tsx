...
export default function TopTable({ title, subtitle, color, colorLight, rows }: Props) {
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerRight}>
          ...
          >
            ...
            <option value="dateAdded">By Date</option>
          </select>
              ...
              <tr key={r.name} className={styles.row}>
                ...
                <td className={styles.name}>
                  ...
                  <div className={styles.barWrap}>
                    <div className={styles.barFill} style={{ width: `${(r.revenue / max) * 100}%` }} />
                  </div>
                </td>
